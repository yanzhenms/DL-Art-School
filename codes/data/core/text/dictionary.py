...
class Dictionary(object):
    ...
    def __init__(
        ...
        self.br0_index = self.add_symbol("br0")
        self.br1_index = self.add_symbol("br1")
        self.br0_index_1 = self.add_symbol("br0@@")
        self.bos_index_1 = self.add_symbol("bos@@")
        self.mask_index_1 = self.add_symbol("<mask>")
    ...
    def index(self, sym):
        ...
        logging.info("token unk: " + str(sym))
    ...
    def load(cls, f):
        ...
        """
        d = cls()
        logging.info("loading dict from: " + str(f))
        d.add_from_file(f)
        return d
